...
/**
 * Responsive content: a bottom sheet on mobile, a centered modal on >= sm.
 */
...
>(({ className, children, ...props }, ref) => (
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 grid gap-4 border border-border bg-card p-6 shadow-glow",
        // mobile: bottom sheet
        ...
        "sm:data-[state=open]:slide-in-from-bottom-2 sm:data-[state=closed]:slide-out-to-bottom-0",
